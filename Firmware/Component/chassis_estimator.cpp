...
void ChassisEstimator::set_reference_acc(const float acc_ref[3]) {
    for (int i = 0; i < 3; ++i) {
...
void ChassisEstimator::step(float dt_s) {
    ...
    vel_x_output_port_ = vel_obs_[0][0];
    vel_y_output_port_ = vel_obs_[1][0];
    yaw_output_port_ = yaw_obs_[0];
    omega_z_output_port_ = yaw_obs_[1];
    dist_x_output_port_ = vel_obs_[0][1];
    dist_y_output_port_ = vel_obs_[1][1];
    dist_yaw_output_port_ = yaw_obs_[2];
}
...
void ChassisEstimator::reset() {
    ...
    vel_x_output_port_ = 0.0f;
    vel_y_output_port_ = 0.0f;
    yaw_output_port_ = 0.0f;
    omega_z_output_port_ = 0.0f;
    dist_x_output_port_ = 0.0f;
    dist_y_output_port_ = 0.0f;
    dist_yaw_output_port_ = 0.0f;
